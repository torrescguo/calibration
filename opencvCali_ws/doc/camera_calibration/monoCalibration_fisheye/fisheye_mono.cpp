...
int main() {
	ofstream fout("caliberation_result.txt");  /**    保存定标结果的文件     **/
	    ...
	    *************************************************************************/
	    cout<<"开始提取角点………………"<<endl;
        int image_count=  160;                    /****    图像数量     ****/
        Size board_size = Size(7,7);            /****    定标板上每行、列的角点数       ****/
	   ...
	   // Size square_size = Size(108,108);
	    ...
	    int count = 0;
        string tempsub = "/home/pan/workspace/MatSpace/xr6983_bino_calib/camL/calib";
	    ...
	    *************************************************************************/
	    ...
	    /************************************************************************
	           保存定标结果
	    *************************************************************************/
		cv::FileStorage fs("./intrinsics.yml", true);
        if (fs.isOpened())
        {
	    ...
	    *************************************************************************/
		...
		cv::FileStorage fs1("./newIntrinsics.yml",true);
        if (fs1.isOpened())
        {
