...
echo_and_run cd "/home/hubery/hubery_ff/calibration/kalibr_ws/src/kalibr_cp/aslam_incremental_calibration/incremental_calibration_python"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hubery/hubery_ff/calibration/kalibr_ws/src/kalibr_cp/aslam_incremental_calibration/incremental_calibration_python/setup.py" \
     \
    build --build-base "/home/hubery/hubery_ff/calibration/kalibr_ws/build/kalibr_cp/aslam_incremental_calibration/incremental_calibration_python" \
    install \
    --root="${DESTDIR-/}" \
